...
var StatLabel = (0, import_system2.forwardRef)(function StatLabel2(props, ref) {
  const styles = useStatStyles();
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    import_system2.chakra.dt,
    {
      ref,
      ...props,
      className: (0, import_shared_utils2.cx)("chakra-stat__label", props.className),
      __css: styles.label
    }
  );
});
