...
declare type ToastStatus = "default" | "success" | "error" | "warning" | "info" | "loading";
declare type UpdateFn = (state: ToastState) => void;
declare type CloseAllToastsOptions = {
    positions?: ToastPosition[];
};

export { CreateToastFnReturn as C, RenderProps as R, ToastOptions as T, UseToastOptions as U, ToastMessage as a, ToastId as b, CloseAllToastsOptions as c, ToastState as d, Toast as e, createToastFn as f, createRenderToast as g, ToastProps as h, ToastStatus as i, UpdateFn as j, useToast as u };
